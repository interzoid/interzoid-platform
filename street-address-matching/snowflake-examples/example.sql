...
CREATE OR REPLACE FUNCTION YOUR_DB.PUBLIC.get_address_match(address STRING)
RETURNS VARIANT
LANGUAGE PYTHON
...
def get_match(address):
    ...
    url = "https://api.interzoid.com/getaddressmatch"
    
    # Updated Parameters for Address Matching
    params = {
        "license": license_key,
        "address": address
    }
...
-- Test 1: Single Call
SELECT YOUR_DB.PUBLIC.get_address_match('500 Main Street, Suite 200');