...
def get_match(fullname):
    ...
    params = {
        "license": license_key,
        "fullname": fullname  # Parameter changed from 'company' to 'fullname'
    }
...
-- Test 1: Create a dummy table with the provided names
...
-- Select data and generate Similarity Keys to identify duplicates
SELECT 
    full_name,
    -- The SimKey is the "secret sauce" - identical keys mean the names are likely the same person
    YOUR_DB.PUBLIC.get_individual_match(full_name):SimKey::STRING as sim_key
